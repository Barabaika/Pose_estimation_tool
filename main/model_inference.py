...
for input_file_name in input_files_names_list:
    ...
    out_video_name = '/usr/src/app/tmp_input_files/' + input_file_name.split('.')[0] + '_output.' + input_file_name.split('.')[1]
    out_json_name = '/usr/src/app/tmp_input_files/' + input_file_name.split('.')[0] + '_output.' + 'json'
